...
<div class="content-page">
    <h1 class="title"><?php
        ...
        echo $this->Html->link($product['ProductCategory']['name'], array('action' => 'productCategory', 'slug' => $product['ProductCategory']['slug'])) ?> / <?php echo $product['Product']['name'] ?></h1>
    <div class="row">
        <div class="col-md-5">
        ...
        <div class="col-md-7">
            <div class="name">
                <?php
                echo '<strong style="color: #1b6eff">' .$product['Product']['name'].'</strong>';
                ?>
            </div>
    ...
    <div class="row">
        <div class="col-md-12 detailProduct">
            ...
            <a class="btn btn-sm btn-default" data-toggle="modal" data-target="#myModal">Đăng ký hưởng ưu đãi</a>
            ...
            <div class="comment-facebook overlay">
                ...
                <div class="col-md-3 block-sidebar productincat">
                    <div class="description">
                        <?php
                            ...
                            echo '<br>';
                            echo $this->Text->truncate($item['Product']['name'], 35);
                            echo '</a>';
                        ?>
                    </div>
                </div>
