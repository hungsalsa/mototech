...
<div class="menu-top">
    <div class="container">
        <div class="row list-inline">
            <div class="col-md-3"><a href="<?= Router::url('/p/cac-dia-chi-he-thong-mototech'); ?>">Địa chỉ Moto</a></div>
            <div class="col-md-3"><a href="<?= Router::url('/p/quy-trinh-dich-vu-bao-duong-va-sua-chua-xe-may'); ?>">Quy trình bảo dưỡng</a> </div>
            <div class="col-md-3">Giải đáp <span>kỹ thuật</span> : <strong><?php echo $settings['Company']['phone'] ?></strong></div>
            <div class="col-md-3">Cứu hộ <span>khẩn cấp</span> : <strong><?php echo $settings['Company']['phone_sos'] ?></strong></div>
        </div>
                ...
                <li class="list-group-item list-category-image">
                    ...
                    if ($categoriesLeftList['product_categories']) {
                        ...
                        foreach ($categoriesLeftList['product_categories'] as $sub) {
                            ...
                            echo '<li>'.$this->Html->link($this->Html->image(Configure::read('settings.imageDir').'50/'.$sub['image']).$sub['name'], array('action' => 'productCategory', 'slug' => $sub['slug']), array('escape' => false)).'</li>';
                        }
                        echo '</ul>';
...
<div class="row">
    ...
    <div class="col-md-3" id="sidebar">
        ...
        <div class="fb-page pagefacebook" data-href="https://www.facebook.com/hotromototech/" data-tabs="timeline" data-width="242" data-height="270" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/hotromototech/" class="fb-xfbml-parse-ignore"><a rel="nofollow" href="https://www.facebook.com/hotromototech/">Hỗ trợ Mototech</a></blockquote></div>      
        <?php
        foreach ($introductions as $item):
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                if ($settings['Company']['facebook']) {
                  echo '<a href="'.$settings['Company']['facebook'].'"><span class="social icon-facebook"></span></a>';
                }
...
<a href="/trang-lien-he"><button type="button" class="buttonSale btn btn-danger btn-sm" data-toggle="modal" data-target="#myModal">Nhắn tin cho quản lý<br><strong>Mototech</strong></span>
</button></a>

<a class="back-to-top" style="right: 105px">
    <?php echo $this->Html->image('../frontend/img/back-to-top.png'); ?>
</a>
<?php
