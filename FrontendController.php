...
class FrontendController extends AppController{
    ...
    public $cacheAction = array(
        'index' => array('callbacks' => true, 'duration' => 86400),
        'pageView' => array('callbacks' => true, 'duration' => 86400),
        'postIndex' => array('callbacks' => true, 'duration' => 86400),
        'productCategory' => array('callbacks' => true, 'duration' => 86400),
        'postCategory' => array('callbacks' => true, 'duration' => 86400),
        'productIndex' => array('callbacks' => true, 'duration' => 86400),
        'siteMap' => array('callbacks' => true, 'duration' => 86400),
        'allProducts' => array('callbacks' => true, 'duration' => 86400),
    );
    ...
    public function getAllProductForCategory($category, $page = 0, $manufacture = null) {
        ...
        $this->Paginator->settings = array(
            ...
            'recursive' => -1,
            'fields' => 'name, image, slug, price, price_sale, id',
            'order' => array(
                'Product.order' => 'asc',
    ...
    public function allProducts($page = 0) {
        ...
        if (!$products || !$paging) {
            $this->Paginator->settings['Product'] = array(
                ...
                'recursive' => -1,
                'limit' => Configure::read('settings.limitFrontend'),
                'fields' => 'id, name, slug, image, price, price_sale'
            );
            $products = $this->Paginator->paginate('Product');
    ...
    public function postCategory($slug, $page = 0)
    {
        ...
        if (!$category) {
            $category = $this->BlogCategory->find('first', array(
                ...
                'recursive' => 0,
                'fields' => array('id', 'name', 'introduction', 'slug')
            ));
            Cache::write('BlogCategory-'.$slug, $category);
        }
		
		//Tu lam
			$idParent = $this->BlogCategory->find('list', array(
				'fields' => array('id'),
				'conditions' => array(
        ...
        $this->Paginator->settings['conditions'] = array(
			...
			//Tu them
			'Post.blog_category_id IN' => $idParent,
        );
    ...
    public function getAllProductForManufacture($id, $page) {
        ...
        $this->Paginator->settings = array(
            ...
            'recursive' => -1,
            'fields' => 'name, image, slug, price, id',
            'order' => array(
                'Product.order' => 'asc',
                'Product.created' => 'desc'
            ),
